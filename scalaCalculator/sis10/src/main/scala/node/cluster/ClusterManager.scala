...
object ClusterManager {
  ...
  case class Found(list: Set[ActorRef[Node.Command]]) extends ClusterMessage
  case class Found2(replyTo: ActorRef[ClusterMembers]) extends ClusterMessage
...
//  def myTemp(replyTo: ActorRef[Pong], list: Set[ActorRef[Node.Command]]): Behavior[ClusterMessage] ={
//    Behaviors.receiveMessage { message =>
//      message match {
//        case GetMembers(replyTo) => {
//          replyTo ! ClusterMembers(list)
//          Behaviors.same
//        }
//      }
//    }
...
//          membersList :+= "i.toString()2"
//          membersList :+= "i.toString()3"
//
//          replyTo ! ClusterMembers(membersList)
//          println("SIZE -> " + membersList.size)
        case Found2(_)=>
            println("Found2")
